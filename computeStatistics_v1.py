...
with open(archivo_resultados, 'w') as resultado_file:
	...
	resultado_file.write(f"MODE\t{modaTC1} (Frecuencia: {frecuencias[modaTC1]})\t{modaTC2} (Frecuencia: {frecuencias[modaTC2]})\t{modaTC3} (Frecuencia: {frecuencias[modaTC3]})\t{modaTC4} (Frecuencia: {frecuencias[modaTC4]})\t{modaTC5} (Frecuencia: {frecuencias[modaTC5]})\t{modaTC6} (Frecuencia: {frecuencias[modaTC6]})\t{modaTC7} (Frecuencia: {frecuencias[modaTC7]})\n")
